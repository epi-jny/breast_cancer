...
_DEMO_IMG = os.path.join(
    PROJECT_DIR, "data/preprocess_image/sample_docker/cropped_images/10226/530620473.png"
)
if not os.path.exists(_DEMO_IMG):
    # Fallback : première image disponible dans rsna_output
    import glob
    _candidates = glob.glob(
        os.path.join(PROJECT_DIR, "data/preprocess_image/rsna_output/cropped_images/*/*.png")
    )
